...
router.get('/cart', verifyLogin, verifyCart, async(req, res) => {
    ...
    // {
    //     _id: new ObjectId("626e300d11b6117e8eb6a388"),
    //     item: new ObjectId("6264087a7e74c0a71e05e8f1"),
    //     quantity: 8,
    //     product: {
    //       _id: new ObjectId("6264087a7e74c0a71e05e8f1"),
    //       Name: 'Samsung Galaxy S22 Ultra 5G ',
    //       Category: 'Mobile',
    //       Price: '110000',
    //       Description: '(Phantom Black, 12GB, 256GB Storage) with No Cost EMI/Additional Exchange Offers'
    //     }
    //   }
    // let total = products.quantity * products.product.Price
    // console.log(products)
